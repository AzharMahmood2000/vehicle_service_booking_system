        ...
        <div className="left-panel-content">
          <div className="enterprise-badge">
            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2L3 7v9.423c0 3.737 2.373 7.159 6.014 8.21l2.986.862 2.986-.862C18.627 23.582 21 20.16 21 16.423V7L12 2zm-1.127 15.353l-4.226-4.225 1.414-1.414 2.812 2.811 5.922-5.922 1.414 1.414-7.336 7.336z"></path>
            </svg>
            ENTERPRISE PORTAL
          </div>
          ...
          <p className="left-desc">
            Securely access bookings, service categories, appointment statuses, and real-time dashboard reports in our unified management suite.
          </p>
              ...
              <form onSubmit={handleLogin} className="admin-form">
                ...
                <div className="form-group">
                  ...
                  <div className="admin-login-input-wrapper">
                    ...
                    />
                    <button type="button" className="admin-login-eye-button" onClick={() => setShowPassword(!showPassword)}>
