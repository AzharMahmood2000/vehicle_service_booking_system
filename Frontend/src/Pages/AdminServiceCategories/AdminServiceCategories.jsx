    ...
    const fetchServiceCategories = async () => {
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/services/admin/all`,
          {
            method: 'GET',
            headers: {
        ...
        if (!response.ok || !data.success) {
          throw new Error(
            data.message || 'Failed to load service categories'
          );
        }
        ...
        const formattedCategories = data.services.map((service) => ({
          ...
          price: `Rs ${Number(service.price).toLocaleString('en-GB', {
        ...
        <div className="categories-scroll-area">
          <div className="categories-header">
            <div className="header-text">
              ...
              <p>
                Manage your high-performance service catalog.
                Define pricing, durations, and availability for
          ...
          <div className="categories-grid">
            ...
            <div
              className="service-card add-new-card"
          ...
          >
            <div className="modal-header">
              <div>
                ...
                <p>
                  {editingServiceId
                    ? 'Update service specifications and pricing'
                    : 'Setup service specifications and pricing'}
                </p>
              </div>
                ...
                >
                  ...
                  !editingServiceId ? (
                    <>
                      ...
                      <span>
                        Upload cinematic service visual
                      </span>
                    </>
                  ) : (
                    <div
